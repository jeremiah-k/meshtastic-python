...
| `meshtastic.interfaces.ble.interface`                 | `_from_num_handler()`                                               | `from_num_handler()`                                                                              |
| `meshtastic.interfaces.ble.interface`                 | `_log_radio_handler()`                                              | `log_radio_handler()`                                                                             |
| `meshtastic.interfaces.ble.interface`                 | `_legacy_log_radio_handler()`                                       | `legacy_log_radio_handler()`                                                                      |
