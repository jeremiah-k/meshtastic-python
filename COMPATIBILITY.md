...
| `meshtastic.interfaces.ble.management_service._create_management_client`                   | `INTERNAL_COMPAT`    | Silent         | Internal facade re-export from `management_service`.                                |
| `meshtastic.interfaces.ble.management_service._is_blank_or_malformed_address_like`         | `INTERNAL_COMPAT`    | Silent         | Internal facade re-export from `management_service`.                                |
