...
| `meshtastic.interfaces.ble.management_service`        | `_create_management_client`                                         | Internal facade re-export from `management_runtime`                                               |
| `meshtastic.interfaces.ble.management_service`        | `_is_blank_or_malformed_address_like`                               | Internal facade re-export from `management_runtime`                                               |
