...
| `meshtastic.interfaces.ble.client`                    | `read_gatt_char()`                                                  | `meshtastic.interfaces.ble.client.read_gatt_char()`                                               |
| `meshtastic.interfaces.ble.client`                    | `start_notify()`                                                    | `meshtastic.interfaces.ble.client.start_notify()`                                                 |
