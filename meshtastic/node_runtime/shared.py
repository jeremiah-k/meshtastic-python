...
def _isNamedAdminChannelName(channel_name: str) -> bool:
...
def _orderedAdminIndexes(*indexes: int | None) -> list[int]:
...
isNamedAdminChannelName = _isNamedAdminChannelName
orderedAdminIndexes = _orderedAdminIndexes
