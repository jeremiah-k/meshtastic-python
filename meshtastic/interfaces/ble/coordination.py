...
class ThreadCoordinator:
    ...
    def create_thread(
        ...
        *,
        ...
        """Create and register a thread through the public wrapper."""
    ...
    def start_thread(self, thread: ThreadLike) -> None:
        """Start a thread through the public wrapper."""
    ...
    def join_thread(self, thread: ThreadLike, timeout: float | None = None) -> None:
        """Join a thread through the public wrapper."""
    ...
    def set_event(self, name: str) -> None:
        """Set a named event through the public wrapper."""
    ...
    def clear_event(self, name: str) -> None:
        """Clear a named event through the public wrapper."""
    ...
    def wait_for_event(self, name: str, timeout: float | None = None) -> bool:
        """Wait for an event through the public wrapper."""
    ...
    def check_and_clear_event(self, name: str) -> bool:
        """Check and clear an event through the public wrapper."""
    ...
    def wake_waiting_threads(self, *event_names: str) -> None:
        """Wake waiting threads through the public wrapper."""
    ...
    def clear_events(self, *event_names: str) -> None:
        """Clear events through the public wrapper."""
    ...
    def cleanup(self) -> None:
        """Run coordinated shutdown through the public wrapper."""
        self._cleanup()
